/*xdk-auto-gen:service-methods:common:start:dba254e12eff26f44feabc95b2f94010*/
...
intel.xdk.services.iodocs_.GetTroubleTkt = ((function (credentials, helpers) {
  var exports = {};
  
  exports.default = function(params) {
    var url = 'http://localhost:5104/api/GetExstkt';
    url = url + '?' + $.param(params);
    return $.ajax({url: url, type: 'GET'});
  };
  ...
  return exports;
}))(intel.xdk.services.credentials.GetTroubleTkt,intel.xdk.services.iodocs_.helpers);
...
/*xdk-auto-gen:service-methods:GetTroubleTkt:start:5135fb0b9117fd9b28c6632a6cc1ced1*/
intel.xdk.services.GetTroubleTkt=intel.xdk.services.iodocs_.bindCommon.bind(null,"intel.xdk.services.GetTroubleTkt",intel.xdk.services.iodocs_.GetTroubleTkt["default"],{cid:"123456",did:"2356",__proto__:{}});
/*xdk-auto-gen:service-methods:GetTroubleTkt:end*/
